...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for COVID 19 Test Antigen(Issuer type: Inspire Health)
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordHealthCovid19AntigenInspireHealthDependent(unittest.TestCase):
    ...
    def test_link_record_health_covid_19_antigen_inspire_health_dependent(self):
