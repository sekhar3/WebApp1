...
Description    : This class is used to enable push notifications
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestNotificationPreferencesEnablePush(unittest.TestCase):
    ...
    def test_enable_push_notifications(self):
        ...
        with allure.step("Clicking PUsh Notifications toggle bar for Enabling notifications"):
            self.upass_holder_portal.click_enable_push_notifications()
