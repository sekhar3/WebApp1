...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for driver license
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordIdDriverLicenseDependent(unittest.TestCase):
    ...
    def test_link_record_id_driver_license_dependent(self):
        ...
        with allure.step("Select the dependent"):
        ...
        with allure.step("Selecting issuer type: Alabama"):
            self.upass_holder_portal.select_issuer_type_alabama()
            LOGGER.info("Select issuer type: Alabama")
        ...
        with allure.step("Verifying Alabama Drivers License record"):
            self.upass_holder_portal.verify_alabama_driver_license_record()
            LOGGER.info("Verify Alabama Drivers License record")
