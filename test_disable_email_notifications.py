...
Description    : This class is used to Disable Email Notifications
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestNotificationPreferencesDisableEmail(unittest.TestCase):
    ...
    def test_disable_email_notifications(self):
        ...
        with allure.step("Clicking Email toggle bar for Enabling notifications"):
            self.upass_holder_portal.click_disable_email_notifications()
