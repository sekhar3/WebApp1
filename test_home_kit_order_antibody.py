...
class TestHomeOrderKitAntibody(unittest.TestCase):
    ...
    def test_home_kit_order_antibody(self):
        ...
        with allure.step("Selecting Order Quantity of Antibody Test Kit"):
            self.upass_holder_portal.select_antibody_test()
