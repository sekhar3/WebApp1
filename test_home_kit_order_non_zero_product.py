...
"""
    ...
    Description         : This method is used to Order Home Kit Non Zero Product
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestHomeOrderNonZeroProduct(unittest.TestCase):
    ...
    def test_home_kit_order_non_zero_product(self):
        ...
        with allure.step("Selecting Order Quantity of Antigen Test Kit"):
            self.upass_holder_portal.select_non_zero_product()
