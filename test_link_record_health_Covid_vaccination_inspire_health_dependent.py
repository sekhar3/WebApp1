...
class TestLinkRecordHealthCovidVaccinationInspireHealthDependent(unittest.TestCase):
    ...
    def test_link_record_health_covid_vaccination_inspire_health_dependent(self):
