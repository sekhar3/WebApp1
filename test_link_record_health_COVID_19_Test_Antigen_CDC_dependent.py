...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for COVID 19 Test Antigen(Issuer type: CDC)
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordHealthCovid19AntigenCdcDependent(unittest.TestCase):
    ...
    def test_link_record_health_covid_19_antigen_cdc_dependent(self):
        ...
        with allure.step("Selecting record type: covid 19 test antigen"):
            self.upass_holder_portal.select_record_type_covid_19_test_antigen()
            LOGGER.info("Select record type: covid 19 test antigen")

        with allure.step("Select issuer type: CDC"):
        ...
        with allure.step("Verifying covid 19 test antigen health record"):
            self.upass_holder_portal.verify_covid_19_test_antigen()
            LOGGER.info("Verify covid 19 test antigen health record")
