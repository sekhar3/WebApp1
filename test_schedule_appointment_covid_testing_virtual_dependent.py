...
"""
    ...
    Description         : This method is used to Schedule an Virtual Appointment for Dependent
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestScheduleCovidTestingVirtualAppointmentDependent(unittest.TestCase):
    ...
    def test_schedule_covid_testing_virtual_appointment_dependent(self):
        ...
        with allure.step("Clicking Appointments button"):
            self.upass_holder_portal.click_appointments()

        with allure.step("Clicking Dependent Appointments button "):
