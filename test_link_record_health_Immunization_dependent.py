...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for Immunization(Issuer type: CDC)
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordHealthImmunizationD(unittest.TestCase):
    ...
    def test_link_record_health_immunization(self):
        ...
        with allure.step("Selecting record type: Immunization"):
            self.upass_holder_portal.select_record_type_immunization()
            LOGGER.info("Select record type: Immunization")
        ...
        with allure.step("Verifying immunization health record"):
            self.upass_holder_portal.verify_immunization()
            LOGGER.info("Verify immunization health record")
