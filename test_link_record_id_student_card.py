...
class TestLinkRecordIdStudentCard(unittest.TestCase):
    ...
    def test_link_record_id_student_card(self):
        ...
        with allure.step("Verifying Student ID record"):
            self.upass_holder_portal.verify_student_id_card_record()
            LOGGER.info("Verify Student ID record")
