...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for Alabama driver license
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordIdAlabamaDriverLicense(unittest.TestCase):
    ...
    def test_link_record_id_alabama_driver_license(self):
        ...
        with allure.step("Selecting issuer type: Alabama - Driver License Division"):
            self.upass_holder_portal.select_issuer_type_alabama()
            LOGGER.info("Select issuer type: Alabama - Driver License Division")
        ...
        with allure.step("Verifying Alabama Driver's License record"):
            self.upass_holder_portal.verify_alabama_driver_license_record()
            LOGGER.info("Verify Alabama Driver's License record")
