...
"""
    @author             : Somasekhar
    Description         : This method is used to Link record for COVID vaccination(Issuer type: CDC)
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestLinkRecordHealthCovidVaccinationCDCDependent(unittest.TestCase):
    ...
    def test_link_record_health_covid_vaccination_cdc_dependent(self):
        ...
        with allure.step("Clicking Health tab"):
            self.upass_holder_portal.click_health_tb()
            LOGGER.info("Click Health tab")
