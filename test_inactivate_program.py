...
"""
    @author     : Somasekhar
    Description : This class is used to change the program status active to inactive
"""


class TestProgramInActive(ManagerBaseTest):
    ManagerAppPortal = ManagerPortal(driver)

    def test_program_inactive(self):
        ...
        with allure.step("Selecting the program status is InActive"):
            self.ManagerAppPortal.select_the_program_status_inactive()
