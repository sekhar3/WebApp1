...
Description    : This class is used to Disable Push Notifications
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestNotificationPreferencesDisablePush(unittest.TestCase):
    ...
    def test_disable_push_notifications(self):
        ...
        with allure.step("Clicking Push Notification toggle bar for Enabling notifications"):
            self.upass_holder_portal.click_disable_push_notifications()
