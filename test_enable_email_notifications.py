...
Description    : This class is used to enable email notifications 
"""


@pytest.mark.usefixtures("beforeClass", "beforeMethod")
class TestNotificationPreferencesEnableEmail(unittest.TestCase):
    ...
    def test_enable_email_notifications(self):
        ...
        with allure.step("Clicking Email toggle bar for Enabling notifications"):
            self.upass_holder_portal.click_enable_email_notifications()
